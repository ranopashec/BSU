Index of all my school projects
# 1st year
## 1 semester
- [C++ Programming](https://github.com/ranopashec/cpp)
- [C++ in Yandex Group](https://github.com/ranopashec/cpp)
- Calculus
- Higher algebra
- Higher geometry
## 2 semester
- Calculus
- [Assembler](https://github.com/ranopashec/cpp)
- [Object Oriented Programming](https://github.com/ranopashec/cpp)
- Higher algebra
